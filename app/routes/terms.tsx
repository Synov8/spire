...
export function meta() {
  return [
    { title: "Terms of Service | Spire" },
    { name: "description", content: "Spire's terms of service for using our SOC 2 and EU AI Act compliance automation platform. Covers account terms, data processing, service level agreements, and acceptable use." },
    { property: "og:title", content: "Terms of Service | Spire" },
