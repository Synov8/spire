...
export function softwareApplicationSchema(): Schema {
  return {
    ...
    operatingSystem: "Web",
    description:
      "AI-powered SOC 2 and EU AI Act compliance automation for B2B SaaS — continuous evidence collection across 9 integrations via Composio, AI questionnaire autofill, and audit-ready exports.",
    url: SITE_URL,
    ...
    featureList: [
      "Continuous evidence collection via Composio (9 integrations: AWS, GitHub, Google Workspace, Vercel, Cloudflare, Clerk, Supabase, Stripe, Resend).",
