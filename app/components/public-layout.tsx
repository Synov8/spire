              ...
              {[...Array(2)].flatMap(() => [
                <a key="ts" href="https://www.tinystartups.com/startup/spire" target="_blank" rel="noopener"
                  ...
                  <svg width="40" height="40" viewBox="0 0 100 100">
                    <defs><linearGradient id="tsg2" x1=".1" y1="0" x2=".9" y2="1"><stop offset="0%" stopColor="#3525E6"/><stop offset="55%" stopColor="#D81FE0"/><stop offset="100%" stopColor="#22B8F0"/></linearGradient></defs>
                  ...
                  <span style={{display:"flex",flexDirection:"column",lineHeight:"1.15"}}>
                    ...
                    <span style={{fontSize:"16px",fontWeight:800,letterSpacing:"-0.02em",color:"#fff"}}>Tiny Startups</span>
                    <span style={{fontSize:"9px",color:"rgba(255,255,255,0.55)",marginTop:"2px"}}>tinystartups.com</span>
                  </span>
                </a>,
                <a key="ph" href="https://www.producthunt.com/products/spire-6" target="_blank" rel="noopener noreferrer" className="flex h-[54px] shrink-0 items-center">
