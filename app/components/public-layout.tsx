      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-10 border-t border-[#1C1C24] pt-8 text-center">
          <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
            ...
            <a href="https://www.producthunt.com/products/spire-6?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-spire-6" target="_blank" rel="noopener noreferrer" className="flex h-[54px] items-center">
              <img alt="Spire - AI-powered SOC 2 &amp; EU AI Act compliance | Product Hunt" width="250" height="54" src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1183433&theme=dark&t=1782720497497" className="h-full w-auto" /></a>
            <a href='https://www.sideprojectors.com/project/84002/spire' target="_blank" rel="noopener" className="flex h-[54px] items-center"><img src='https://www.sideprojectors.com/img/badges/badge_show_black.png' alt='Check out Spire at SideProjectors' className="h-full w-auto" /></a>
            <a href="https://saascubes.com" rel="noopener" title="Listed on SaaS Cubes" className="flex h-[54px] items-center"><img src="https://saascubes.com/images/badges/badge-dark.png" alt="Listed on SaaS Cubes" className="h-full w-auto" /></a>
          </div>
